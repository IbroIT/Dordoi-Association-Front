  ...
  return (
    <section ref={ref} className="relative py-20 bg-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <h4 className="text-lg font-bold text-slate-900 mb-4">
                {t('contactsInfo.stats.title')}
              </h4>
              <div className="space-y-3">
                {t('contactsInfo.stats.items', { returnObjects: true }).map((stat, index) => (
                  <motion.div
                    key={index}
              ...
              >
                <div className={`${colorMap[activeDepartmentData.color].light} p-8`}>
                  <div className="flex items-start justify-between mb-4">
                    ...
                    {/* Время ответа */}
                    <motion.div
                      className="bg-white/80 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/20"
                      whileHover={{ scale: 1.05 }}
                    >
                      <div className="text-sm text-slate-600">{t('contactsInfo.responseTime')}</div>
                      <div className="font-semibold text-slate-900">{activeDepartmentData.responseTime}</div>
                    </motion.div>
                  </div>

                  <p className="text-slate-700 text-lg leading-relaxed">
                    {activeDepartmentData.detailed}
                  </p>
                </div>
                ...
                <div className="p-8">
                  <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-slate-900 mb-6">
                        {t('contactsInfo.services.title')}
                      </h4>

                      <div className="space-y-3 mb-6">
                        {activeDepartmentData.services.map((service, index) => (
                          <motion.div
                            key={index}
                            className="flex items-center space-x-3 p-3 bg-slate-50 rounded-lg border border-slate-200"
                            whileHover={{ x: 5 }}
                          >
                            <div className={`w-2 h-2 rounded-full ${colorMap[activeDepartmentData.color].dark}`}></div>
                  ...
                  >
                    <motion.button
                      className={`bg-gradient-to-r ${colorMap[activeDepartmentData.color].gradient} text-white px-8 py-4 rounded-xl font-semibold hover:shadow-xl transition-all duration-300 inline-flex items-center space-x-3`}
                    ...
                    >
                      ...
                      <span>{t('contactsInfo.quickContact')}</span>
                    </motion.button>
                  </motion.div>
                </div>
              </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-3xl p-8 md:p-12 border border-blue-200 shadow-lg">
            <motion.h3 
              variants={itemVariants}
      ...
      <AnimatePresence>
        {copiedField && (
          ...
          >
            {t('contactsInfo.copiedNotification')}
          </motion.div>
        )}
      </AnimatePresence>
    </section>
